...
<span style="font-size: 4rem; font-weight: 700; display: block; margin-bottom: 0.1rem;">Wajdi Alnoush</span> <br>
<span style="font-size: 2.5rem;">Postdoc <a href='#'>@Employer</a>.<br>
...
<div style="border: 0.4px solid #6b7280; border-radius: 10px; padding: 1.5rem; background-color: transparent;">
  <h4 style="font-size: 2.5rem; font-weight: 700;">About</h4>
    <p>
    ...
    <h4 style="font-size: 2.5rem; font-weight: 700;" class="card-title">Recent publications</h4>
